...
void initMGraph(MGraph *graph, char *names[], int num, int directed, int edgeValue) {//初始化邻接矩阵(图,顶点名称main函数中额外定义的,个数,方向,初始化权值)
...
//给边添加权值/有无
void addMGraphEdge(MGraph *graph, int x, int y, int w) {//添加边(x顶点,y顶点,权值)
